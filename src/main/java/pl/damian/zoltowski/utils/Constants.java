...
public class Constants {
    ...
    public final static int POPULATION_OPERATORS_STOP_CONDITION = 30;
    ...
    public final static double SEGMENTS_OUT_OF_BOARD_PENALTY = 19.5;
    public final static double LENGTH_PENALTY = 9.0;
